-- Nicolenails — disponibilidad con varias personas trabajando a la vez
--
-- Sustituye get_available_slots: en vez de bloquear un hueco en cuanto
-- existe UNA cita, lo bloquea solo cuando el nº de citas activas (pending +
-- accepted) que se solapan iguala o supera el nº de personal activo.
-- create_appointment no cambia: sigue revalidando a través de esta función.
